...
# files
SEG_MODEL_FILE=results/gtmxysh6_100/wandb-lightning/gtmxysh6/checkpoints/epoch=22-step=7222.ckpt
HIST_EQ=true
# data/output_logger/qhdxygp3_100/wandb-lightning/qhdxygp3/checkpoints/epoch=30-step=961.ckpt
...
cp $GM_PROJECT_FOLDER/$RESULTS_FOLDER/${DATE}_$SUBSET/registration_results_${MODALITY,,}_${SEGDATE}/results.csv \
$GM_PROJECT_FOLDER/$RESULTS_FOLDER/${DATE}_$SUBSET/area_comparisons_${MODALITY,,}_${SEGDATE}_wmetadata.csv
